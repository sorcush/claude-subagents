...
harness_run() {
  ...
  # cursor-agent has no working-folder flag. Let the timeout helper enter $dir so
  # its process-group state remains visible in this shell after the command exits.
